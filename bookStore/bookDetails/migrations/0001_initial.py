# Generated by Django 2.1.5 on 2019-02-15 22:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_cover', models.ImageField(blank=True, null=True, upload_to='bookDetails/')),
                ...
                ('book_author', models.ManyToManyField(related_name='authored', to='bookDetails.Author')),
            ],
            options={
                'ordering': ('book_name',),
            },
